...
function HeadingBulletedList({heading, items}: HeadingBulletedListProps) {
    return (
        <>
            <h3 className="text-primary font-semibold text-lg md:text-xl mb-2">{heading}</h3>
            <ol className="list-disc list-inside mb-6 text-base md:text-lg">
                {items.map((item, i) => (
                    <li key={i}>{item}</li>                    
                ))}
            </ol>
    ...
    return (
        <main>
            ...
            <section className="relative">
                <div className="relative bg-other-materials bg-cover bg-center py-32 md:py-52 min-h-[400px] px-10 md:px-20 mb-20">
                    ...
                    &rarr;
                    {" "}
                    <Link href="/friction-and-metallurgical-materials/other-materials" className="hover:underline">
                        Other Friction & Metallurgical Materials
                    </Link>
                    </p>
                    <div className="relative z-10 px-4 md:px-10 w-full">  
                    </div>
                </div>
            ...
            {/* Intro Section */}
            <section>
                <div className="flex flex-col md:flex-row px-6 md:px-40 py-10 md:py-20 gap-8 md:gap-32">
                    <div className="w-full md:w-3/5">
                        <h2 className="text-2xl md:text-4xl mb-4">High-Performance Friction Materials</h2>
            ...
            {/* Materials Section */}
            <section>
                <div className="px-6 md:px-40 py-10 md:py-20">
                    <h2 className="text-2xl md:text-4xl mb-4">Friction Materials We Offer</h2>
                    <p className="text-base md:text-lg mb-10 md:mb-16">
                        Explore our core material categories used in the production of friction products — from binders and reinforcements to oxides, fillers, and specialty powders, all trusted across foundry and manufacturing industries.
                    </p>
                    
                    {/* First Row */}
                    <div className="flex flex-col md:flex-row gap-8 md:gap-12 mb-8 md:mb-12">
                        <div className="w-full md:w-1/3">
                            <div className="bg-accent-light aspect-square w-12 md:w-16 flex items-center justify-center rounded-full mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-8 md:size-10 fill-accent">
            ...
            {/* CTA Section */}
            <section>
                <div className="px-6 md:px-40 py-10 md:py-20 text-center">
                    <h2 className="text-xl md:text-2xl mb-4">Ready to Source Reliable Friction Materials?</h2>
                    <p className="text-base md:text-lg mb-6">
                        Whether you&apos;re optimizing an existing formulation or developing a new one, our team can help you find the right materials for your performance needs. Contact us to discuss tailored solutions and get expert guidance.
                    </p>
                    <Link href={`/contact`}>
