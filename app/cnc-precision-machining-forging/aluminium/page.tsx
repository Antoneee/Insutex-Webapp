    ...
    return (
        <main>
            <section className="w-full">
                <div className="relative w-full bg-aluminium bg-cover bg-center py-32 md:py-52 min-h-[400px] px-10 md:px-20 mb-20">
                ...
                <p className="relative z-10 text-base md:text-xl text-neutral-white">
                    ...
                    &rarr;
                    {" "}
                    <Link href="/cnc-precision-machining-forging/aluminium" className="hover:underline">
                        Aluminium
                    </Link>
                    </p>
            </div>
