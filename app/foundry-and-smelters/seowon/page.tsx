    ...
    return (
        <main>
            <section className="relative">
                <div className="relative bg-seowon bg-cover bg-center py-32 md:py-52 min-h-[400px] px-10 md:px-20 mb-20">
                    ...
                    &rarr;
                    {" "}
                    <Link href="/foundry-and-smelters/seowon" className="hover:underline">
            ...
            <section>
                <div className="flex flex-col md:flex-row gap-10 px-4 md:px-40 mb-20 items-center">
                    <div className="md:w-1/5 w-2/3 flex justify-center md:justify-start">
                        <Image src={SeowonLogo} alt="Seowon logo" className="h-auto max-h-32 md:max-h-64 w-auto" />
                    </div>
                    <div className="md:w-4/5 w-full">
                        <h2 className="text-3xl md:text-4xl mb-4">Seowon Co., Ltd.</h2>
                        <p className="text-lg">
            ...
            <section>
                <div className="flex flex-col-reverse md:flex-row px-4 md:px-40 py-20 gap-10 md:gap-32">
                    <div className="md:w-2/3 w-full">
                        <h2 className="text-3xl md:text-4xl mb-4">High-Performance Brass & Bronze</h2>
                        <p className="text-lg">
            ...
            <section>
                <div className="px-4 md:px-40 mb-20">
