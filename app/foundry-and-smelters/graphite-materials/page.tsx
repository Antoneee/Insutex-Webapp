...
function HeadingCheckList({heading, items}: HeadingCheckListProps) {
    return (
        <>
            <h3 className="text-primary font-semibold text-xl md:text-2xl mb-4">{heading}</h3>
            <ol className="list-inside mb-6">
                {items.map((item, i) => (
                    <div key={i} className="flex gap-2 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5 md:size-6 fill-primary">
    ...
    return (
        <main>
            ...
            <section className="relative">
                    <div className="relative bg-graphite-materials bg-cover bg-center py-32 md:py-52 min-h-[400px] px-10 md:px-20 mb-20">                    
            ...
            <section>
                <div className="flex flex-col md:flex-row px-6 md:px-40 py-10 md:py-20 gap-8 md:gap-32">
                    <div className="w-full md:w-1/3 flex items-center">
                        <Image src={AsburyLogo} alt="Asbury logo" className="w-full object-contain max-w-md mx-auto"/>
                    </div>
            ...
            {/* Insutex Partnership Section */}
            <section>
                <div className="px-6 md:px-40 py-10 md:py-20 text-center bg-primary-light">
            ...
            <section>
                <div className="px-6 md:px-40 py-10 md:py-20">
                    <h2 className="mb-6 md:mb-8 text-2xl md:text-3xl">Why Graphite?</h2>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 md:gap-0">
                        <div className="w-full md:w-1/2 md:pr-8">
                            <div className="bg-accent-light aspect-square w-12 md:w-16 flex items-center justify-center rounded-lg mb-4">
            ...
            {/* CTA Section */}
            <section>
                <div className="px-6 md:px-40 pb-10 md:pb-20 text-center">
                    <h2 className="mb-4 text-2xl md:text-3xl">Custom Graphite Solutions for Your Needs</h2>
                    <p className="text-base md:text-lg mb-6">We tailor graphite and carbon materials to meet your specific technical requirements. Reach out to discuss your application needs.</p>
                    <Link href={`/contact`}>
